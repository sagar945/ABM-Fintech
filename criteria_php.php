...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_SESSION['user_id']) && isset($_SESSION['user_name'])) {
        ...
        if ($data && is_array($data)) {
            ...
            $query = "INSERT INTO criteriapage (uid, menu_name, menu_description, field_name, field_type, lchg_userid, rcre_userid, bankid) VALUES (?, ?, ?, ?, ?, ?, ?, ?)";
            ...
            if ($stmt) {
                foreach ($data as $inputValue) {
                    ...
                    $stmt->bind_param("ssssssss", $id, $inputValue['menu_name'], $inputValue['menu_description'], $fieldName, $fieldType, $name, $name,$bankid);
